...
class List{
    ...
    bool isUnique() {
        ...
        Node* selectedNode = headPtr->getNextNodePtr();
        Node* currentNode = selectedNode->getNextNodePtr();
     
        while(selectedNode && currentNode) {
            
                if(selectedNode == currentNode) {
                    continue;
                } else {
                    if(currentNode->getData() == selectedNode->getData())
                        return false;
                }
            
            
            if(currentNode->getNextNodePtr() == NULL) {
                selectedNode = selectedNode->getNextNodePtr();
                currentNode = selectedNode->getNextNodePtr();
            } else if(currentNode->getNextNodePtr()) {
